...
<!-- /engine:2d -->
<!-- engine:3d -->
Read contract-3d.md, genre.md and network.md before FPS implementation. Use doctor,
domain replay, mesh validation and all FPS scenarios, then real Windows executable
smoke. Add networking only when selected. Production records stay under art/builds.
<!-- /engine:3d -->
